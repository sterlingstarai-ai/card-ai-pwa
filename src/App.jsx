...
const NETWORKS_DATA = {
  "VISA": {
    grades: {
      "Infinite": { benefits: [{ icon: "🏨", title: "Luxury Hotel Collection", tags: ["hotel"], value: 50000 }] },
      "Platinum": { benefits: [{ icon: "🛡️", title: "여행자 보험", tags: ["airport"], value: 5000 }] },
      "Standard": { benefits: [] }
    }
  },
  "Mastercard": {
    grades: {
      "World Elite": { benefits: [{ icon: "✈️", title: "공항 라운지", tags: ["airport", "lounge"], value: 40000 }] },
      "World": { benefits: [{ icon: "🚗", title: "호텔 발렛", tags: ["hotel", "valet"], value: 30000 }] },
      "Platinum": { benefits: [] },
      "Standard": { benefits: [] }
    }
  },
  "AMEX": {
    grades: {
      "Platinum": { benefits: [{ icon: "✈️", title: "공항 라운지", tags: ["airport", "lounge"], value: 20000 }] },
      "Standard": { benefits: [] }
    }
  },
  "JCB": {
    grades: {
      "Platinum": { benefits: [{ icon: "✈️", title: "LoungeKey", tags: ["airport", "lounge"], value: 6000 }] },
      "Standard": { benefits: [] }
    }
  },
  "UnionPay": {
    grades: {
      "Platinum": { benefits: [{ icon: "🏨", title: "Hotels.com 20%", tags: ["hotel"], value: 10000 }] },
      "Standard": { benefits: [] }
    }
  }
};
